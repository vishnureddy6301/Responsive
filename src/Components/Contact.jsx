        ...
        <div className="flex flex-col bg-gray-100 min-h-screen">
            <header className="bg-white shadow">
                <div className="container mx-auto px-6 py-3 flex justify-between items-center">
                    <img className="rounded-full object-left-top mx-24 left-0 top-2 w-12 h-12" src={logo} alt="Logo" />
            ...
            <Drawer title="Menu" placement="right" onClose={closeDrawer} visible={drawerVisible}>
                <a href="#" className="block text-gray-800 hover:text-purple-600 mb-2">Home</a>
                <a href="#" className="block text-gray-800 hover:text-purple-600 mb-2">About Us</a>
            ...
            <main className="container mx-auto px-6 py-8">
                <p className="mb-8 font-Rubik text-center text-gray-700">
                    ...
                    share more about your company and how you think we can help. Team NewDefines is here to listen, adjust, and execute changes tailored to your business needs. It's that simple.
                </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="mb-4">
                                ...
                                <input 
                                    ...
                                    type="text" 
                                    placeholder="name" 
                                    className="w-full px-3 py-2 border placeholder-gray-500 rounded-lg focus:outline-none focus:border-gray-600" 
                                />
                            </div>
                            <div className="mb-4">
